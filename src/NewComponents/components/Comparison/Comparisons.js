...
const url = "http://localhost:3000/compareData.json" || 'https://coder-access.web.app/compareData.json'
  useEffect(() => {
    ...
    return (
        <div className="lg:mb-32 mb-20 mt-16 lg:mt-56 max-w-[90vw] mx-auto">
          ...
          /></span></Link>
            ...
            <h2 className='text-xl font-semibold text-amber-400 text-center lg:mb-12 mb-6'>Compare to other site</h2>
             <section>
                <div className='grid grid-cols-6 lg:mx-48 lg:gap-4 content-center overflow-x-scroll md:overflow-x-auto '>
