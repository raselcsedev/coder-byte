...
const Banner = () => {
    return (
        <div className='banner'>
            ...
            <div className='bannerbgphoto grid grid-cols-1 lg:grid-cols-2'>
                <div className='flex justify-center items-center'>
                    <h1 className='text-white font-serif font-bold text-5xl lg:text-7xl'>Best platform to <br /> solve comparative <br /> programming</h1>
                </div>
