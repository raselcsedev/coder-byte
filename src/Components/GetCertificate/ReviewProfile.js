          ...
          <div>
            ...
            <div>
              <div className="lg:flex lg:space-x-24">
                <div class="form-control w-full max-w-xs">
                  ...
                  <input type="text" placeholder="Enter First Name" class="input input-bordered w-full max-w-xs" required />
                </div>
                <div class="form-control w-full max-w-xs">
                  <label class="label">
                    <span class="label-text text-sm">
                  ...
                  <input type="text" placeholder="Enter Last Name" class="input input-bordered w-full max-w-xs" required />
                </div>
              </div>
            ...
            <div className="mt-3 mb-7">
              <div class="form-control w-full max-w-xs">
                ...
                <input type="text" placeholder="Enter Country Name" class="input input-bordered w-full max-w-xs" required />
              </div>
              ...
              <div className="mt-3">
                <div class="form-control w-full max-w-xs">
                  ...
                  <input type="text" placeholder="Phone Number" class="input input-bordered w-full max-w-xs" required />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <div class="form-control w-full max-w-xs mt-3">
                  ...
                  <input type="text" placeholder="Enter School Name" class="input input-bordered w-full max-w-xs" required />
                </div>
              </div>
              ...
              <div className="lg:flex lg:space-x-24 mt-3">
                ...
                <div class="form-control w-full max-w-xs">
                  ...
                  <input type="text" placeholder="Program" class="input input-bordered w-full max-w-xs" />
                </div>
              </div>
            </div>
            ...
            <div className="lg:ml-48 mt-4 mb-7">
              <div class="form-control w-full max-w-xs">
                ...
                <input type="text" placeholder="Add your linkedIn url" class="input input-bordered w-full max-w-xs" />
              </div>
            </div>
