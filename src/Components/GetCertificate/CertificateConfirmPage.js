            ...
            <div className="lg:flex items-center">
              <div>
                <p className="text-3xl font-bold">
                  Welcome to <br /> coderAccess Problem <br /> Solving (Basic) Skills Certification Test
                </p>
              </div>
...
export default CertificateConfirmPage;
