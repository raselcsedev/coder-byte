...
const YourStories = ({ blogger }) => {
    ...
    const blogs = allBlogs?.filter(blog => blog?.blogger != user?.email)

    return (
        <div className='border-l divide-y sticky right-[0%] top-[10%] pt-10 min-h-[90vh]   space-y-10 pl-2 pr-1'>
            ...
            <div className='card  divide divide-y my-4 space-y-4'>
                ...
                <div className="collapse  collapse-arrow border-b-2">
                    ...
                    <div className="collapse-title font-semibold  ">
                        ...
                        {blogs?.length && <h1 className='text-md font-semibold'>Some of your stories :</h1>}
