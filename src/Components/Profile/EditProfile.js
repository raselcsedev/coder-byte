                                    ...
                                    <div class="px-4 py-5  sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <input  {...register("street-address")} style={{ backgroundColor: ' #919cb1', border: '#6b7280' }} type="text" name="street-address" id="street-address" autocomplete="street-address" class="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                            </div>
