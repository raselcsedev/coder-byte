            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <section className=''>
                    <div className='rounded-lg  lg:w-6/6  border-solid border-4 p-5 lg:p-7 shadow-2xl '>
                        ...
                        <Link to='/preparation'><button className="btn my-2">Button</button></Link>
                    </div>
                </section>
                <section className=''>
                    <div className='rounded-lg  lg:w-6/6  border-solid border-4 p-5 lg:p-7 shadow-2xl '>
                    ...
                    <div>
                        <div class="card w-[100%] md:w-96  my-4 md:my-0 md:mx-4 bg-white border text-neutral-content shadow-2xl">
                            <div class="card-body">
                                ...
                                <Link to="/contests"><button class="w-3/6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
                                    View Contests
                                </button></Link>
                            </div>
                        </div>
