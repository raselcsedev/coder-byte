...
const AddSkillTest = () => {
    ...
    const onSubmit = async (data) => {
      ...
      toast.success("Skill-Test Added")
    }
    ...
    return (
       ...
       <form onSubmit={handleSubmit(onSubmit)}>
         <div>
           <div >
             <h1 className='text-2xl font-semibold py-4'>Add A Skill-Test</h1>
             ...
             <div class="md:grid md:grid-cols-3 md:gap-6 ">
               <div class="md:col-span-1">
                 ...
                 <h3 class="text-lg font-medium leading-6 ">Skill-Test Info</h3>
                   ...
                   <div class="px-4 py-5  sm:p-6">
                     <div class="grid grid-cols-6 gap-6">
                       ...
                       <div class="col-span-6 sm:col-span-5">
                         ...
                         <p class="mt-2 text-sm">Brief description for the skill-test & certification. URLs are hyperlinked.</p>
                       </div>
 
                       <div class="col-span-5 md:col-span-5">
                         <label class="block text-sm font-medium">  Skill-Test Image (link) </label>
                         <input  {...register("img ")} style={{ backgroundColor: ' #919cb1', border: '#6b7280' }} type="text" name="region" id="region" autocomplete="address-level1" class="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                        or,
                         <label class="block text-sm font-medium"> Skill-Test Image (upload) </label>
                       ...
                       <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                         <label for="region" class="block text-sm font-medium ">Duration</label>
                       ...
                       <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                         <label for="postalCcode" class="block text-sm font-medium ">Test Quantity</label>
                         <input  {...register("quantity")} style={{ backgroundColor: ' #919cb1', border: '#6b7280' }} type="text" name="postalCode" id="postalCode" autocomplete="postal-code" class=" p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                       </div>
                     </div>
                   </div>
