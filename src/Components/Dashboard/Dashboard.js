...
const Dashboard = () => {
  ...
  return (
    <div className="sm:mx-24 lg:mx-32 pt-20">
      <label htmlFor='my-drawer-2' tabindex="1" class="btn btn-ghost lg:hidden text-[red]">
      ...
      <div class="drawer drawer-mobile ">
        ...
        <div class="drawer-content">
          ...
          <h2 className="text-2xl text-[brown] font-bold my-4">Welcome to your Dashboard</h2>
          <Outlet></Outlet>

        </div>
        <div class="drawer-side drop-shadow-lg">
          <label for="my-drawer-2" class="drawer-overlay"></label>
          <ul class="menu md:m-8  overflow-y-auto md:w-60 w-40 bg-base-100 text-base-content space-y-1">
            ...
            <Link to="/profile">
              <li className="font-semibold text-[black] md:mx-10 mx-4 mt-2 mb-5 text-lg hover:text-[brown]  word-break">{profile?.displayName}</li>
            </Link>
            <li>
              <Link className="bg-[brown] text-white active:text-[brown] active:bg-[#e6a1a1] font-semibold" to="/dashboard">My Courses</Link>
            </li>
            <li>
